...
class SimpleAndroidClient {
 ...
 public:
  ...
  bool IsConnected() const { return connected && connection.IsConnected(); }
...
JNIEXPORT jboolean JNICALL Java_com_mrdesktop_SimpleClient_nativeConnect(
...
JNIEXPORT jboolean JNICALL
Java_com_mrdesktop_SimpleClient_nativeSendTestMessage(
