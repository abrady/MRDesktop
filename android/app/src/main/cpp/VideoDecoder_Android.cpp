...
bool VideoDecoder::Initialize(
  ...
  LOGD(
      "Initializing VideoDecoder: %dx%d, compression=%d",
      width,
      height,
      compression);
...
const char* VideoDecoder::GetCodecName(CompressionType type) {
  switch (type) {
    case COMPRESSION_H264:
      return "H.264 (Android MediaCodec)";
    case COMPRESSION_H265:
      return "H.265 (Android MediaCodec)";
    case COMPRESSION_AV1:
      return "AV1 (Android MediaCodec)";
    default:
      return "Unknown";
  }
}