...
H264Encoder::H264Encoder()
    : m_encoder(nullptr), m_inputType(nullptr), m_outputType(nullptr), m_inputSample(nullptr), m_inputBuffer(nullptr), m_width(0), m_height(0), m_frameCount(0), m_initialized(false), m_forceKeyframe(false), m_frameTime(0), m_inputFormat(MFVideoFormat_RGB32)
{
}
