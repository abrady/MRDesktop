...
WindowManager::WindowManager()
    : m_hInstance(nullptr), m_hwnd(nullptr), m_isFullscreen(false), m_usingSimpleRenderer(false), m_connectionState(ConnectionState::Disconnected), m_serverIP("127.0.0.1"), m_serverPort(8080), m_statusMessage("Disconnected")
{
}
